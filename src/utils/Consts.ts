...
export const COLORS: { id: number; color: string; style: CSSProperties }[] = [
  ...
  },
  {
    ...
    style: {
      boxShadow: 'none',
      background:
        'linear-gradient(45deg, rgba(255, 188, 0, 1) 0%, rgba(255, 245, 28, 1) 100%)'
    }
  },
  {
    id: 4,
    ...
    style: {
      boxShadow: 'none',
      background:
        'linear-gradient(45deg, rgba(120, 20, 206, 1) 0%, 	#DA70D6 100%)'
    }
  },
  {
    id: 5,
    ...
    style: {
      boxShadow: 'none',
      background:
        'linear-gradient(45deg, rgba(0, 87, 7, 1) 0%, rgba(82, 255, 28, 1) 100%)'
    }
  },
  {
    id: 6,
